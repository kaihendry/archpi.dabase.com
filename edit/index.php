...
<?php							?><span class="highlight">============================</span></code></pre>
							</td>
...
<?php							?><span class="highlight">- </span>Unordered list item</code></pre>
							</td>
...
<?php							?><span class="highlight">2. </span>Ordered list item</code></pre>
							</td>
				...
				<div class="top_panel" id="about">
					...
					<p>I made this minimalist online Markdown editor in a couple of hours just for the heck of it.<br/>And also maybe because I love Markdown (and front end stuff).</p>
					...
					<p>Credit is due to <a href="http://daringfireball.net/" target="_blank">John Gruber</a> for creating <a href="http://daringfireball.net/projects/markdown/" target="_blank">Markdown</a> in the first place, and John Fraser for his amazing JavaScript port, <code>showdown.js</code>.</p>
				</div>
			</div>
...
<a href="http://daringfireball.net/projects/markdown/syntax" target="_blank" class="button">Markdown</a>
